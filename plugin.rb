...
after_initialize do
  ...
  class ::UserEmail
	...
	def set_placeholder_email
      self.test_email = PIIEncryption.hash_email(self.email)
    ...
    def self.find_by_email(email)
      ...
      Rails.logger.info "Searching UserEmail by test_email: #{encrypted_email}"
    ...
    def self.exists_with_email?(email)
      encrypted_email = PIIEncryption.encrypt_email(email)
      Rails.logger.info "Checking existence of UserEmail by test_email: #{encrypted_email}"
  ...
  module EmailOverride
    def find_user_by_email(email)
      ...
      Rails.logger.info "Searching User by test_email: #{hashed_email}"
      UserEmail.find_by(test_email: hashed_email)&.user
    end
